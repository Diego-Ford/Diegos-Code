...
combinedData = pd.read_csv('G:/My Drive/Ontonotes NER Output/Input Data/combined.csv', low_memory=False, encoding='latin-1')
...
result.to_csv('G:/My Drive/Ontonotes NER Output/Input Data/combined_no_duplicates_80.csv')
